...
const ContactPage = () => {
  ...
  return (
    <div className="container py-4" style={{ maxWidth: 500 }}>
      <Helmet>
        <title>Contact Us | React E-Commerce</title>
        <meta name="description" content="Get in touch with us. We'd love to hear from you. Fill out our contact form and we'll get back to you soon." />
      </Helmet>
